                ...
                <table width="100%" cellspacing="0" cellpadding="0">
                    <tr>
                        <td style="padding: 10px;">
                            <div class="contact-info">
                                ...
                                <p><img src="https://i.ibb.co/X8FBvY8/Container.png" alt="" style="width: 20px;"> support@Cypbit Trade.com</p>
                    ...
                    <tr>
                        <td style="padding: 20px 0;">
                            ...
                            <h1 style="color: #eb6a07; font-size: 40px; font-family: Impact, sans-serif; font-weight: 500">Cypbit Trade</h1>
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <div class="footer">
                <div class="footer-content">
                    ...
                    <div class="footer-info">
                        ...
                        <p>© Copyright 2024 Cypbit Trade. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
  ...
  try{
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                <p>Hi ${UserEmail.fullName},</p>
                <p>Welcome to Cypbit Trade, your Number 1 online trading platform.<br><br>Your Trading account has been set up successfully.<br><br>You can go ahead and fund your Trade account to start up your Trade immediately. Deposit through Bitcoin.</p>
                <p>For more enquiries, kindly contact your account manager or use our live chat support on our platform. You can also send a direct mail to us at <span style="color: #4c7fff;">${process.env.USER}</span></p>
                <p>Thank you for choosing our platform. We wish you successful trading.</p>
            </div>
    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>You have successfully logged in to Cypbit Trade<br><br><br><br>You can go ahead and fund your Trade account to start up your Trade immediately. Deposit through Bitcoin.</p>
